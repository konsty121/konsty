...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211105_agenstvonedvizhimostitvojdom_5e8e6c0321b120f85325_20211105032648_archive.zip';
	const ARCHIVE_SIZE		 = '39063733';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '5e8e6c0-05032648';
    const SECONDARY_PACKAGE_HASH = '8c94f38-05032648';
	const VERSION			 = '1.4.3';
